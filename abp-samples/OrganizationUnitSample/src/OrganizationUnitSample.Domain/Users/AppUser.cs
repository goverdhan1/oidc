...
namespace OrganizationUnitSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update OrganizationUnitSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update OrganizationUnitSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
