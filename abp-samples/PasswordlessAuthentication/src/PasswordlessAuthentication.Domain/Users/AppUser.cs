...
namespace PasswordlessAuthentication.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PasswordlessAuthenticationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PasswordlessAuthenticationEfCoreEntityExtensionMappings to extend the IdentityUser entity
